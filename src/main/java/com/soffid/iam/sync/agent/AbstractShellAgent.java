...
public abstract class AbstractShellAgent extends Agent {
	...
	private void updateObject(ExtensibleObject obj) throws InternalErrorException {
	...
	protected void parseSentence(String sentence, ExtensibleObject obj, StringBuffer parsedSentence) {
		int position = 0;
	...
	private Collection<? extends ExtensibleObject> selectSystemObjects(ExtensibleObject sample, ExtensibleObjectMapping objectMapping, String sentence,
			String filter, String attributes) throws InternalErrorException {
				List<ExtensibleObject> result = new LinkedList<ExtensibleObject>();
			
				String attributeList[] = attributes == null ? null: attributes.split("[ ,]+");
	...
	public void removeRole(String rolName, String dispatcher) throws RemoteException,
			InternalErrorException {
				Rol role  = new Rol();
				role.setNom(rolName);
	...
	public List<RolGrant> getAccountGrants(String userAccount) throws RemoteException,
			InternalErrorException {
				RolGrant grant = new RolGrant();
	...
	public void updateUser(String accountName, Usuari userData) throws RemoteException,
			InternalErrorException {
				Account acc = new Account();
	...
	public void updateUser(String accountName, String description) throws RemoteException,
			InternalErrorException {
	...
	public void updateUserPassword(String accountName, Usuari userData, Password password,
